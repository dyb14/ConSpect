...
class Cfg:
    ...
    def _learning_params(self):
        return {
            ...
            "smooth_l1_beta": self.config.getfloat("learning", "smooth_l1_beta"),
            "weight_decay": self.config.getfloat("learning", "weight_decay"),
            "max_lr": self.config.getfloat("learning", "max_lr"),
            "pct_start": self.config.getfloat("learning", "pct_start"),
        }
